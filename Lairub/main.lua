...
function lairub:Functions()
	...
	if player:GetPlayerType() == playerType_Lairub and not player:IsDead() then
		--==== Changed Tears ====--	
		--== Changed Icon==--
		if not Input.IsButtonPressed(Keyboard.KEY_LEFT_ALT, player.ControllerIndex) and not ReadySpawnCross == true and not Input.IsButtonPressed(Keyboard.KEY_X, player.ControllerIndex) then
		...
		--====Soul Cross====--
		--==Ready Spawn==--
		if not Input.IsButtonPressed(Keyboard.KEY_LEFT_ALT, player.ControllerIndex) and not Input.IsButtonPressed(Keyboard.KEY_LEFT_SHIFT, player.ControllerIndex) and not Input.IsButtonPressed(Keyboard.KEY_X, player.ControllerIndex) then
